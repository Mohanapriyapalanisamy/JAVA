...
cows = 4 legs
pigs = 4 legs
The farmer has counted his animals and he gives you a subtotal for each species. You have to implement a function that returns the total 
...
public class Farmer {
 public static int animals(int chickens, int cows, int pigs) {
	int total=((chickens*2)+(4*cows)+(4*pigs));//total calculation
	return total;
 }
public static void main(String[] args)
{
	...
	System.out.println(animals(chick,cow,pig));
}
}